...
For Parallelizing:
Now since we are travesing through the list of blocks, this can be easily divided into different task. I can run multiple tasks at a time and then allot different chunks of the list to it. I have used "#pragma omp parallel for" construct for this, this internally is implememnted using "#pragma omp task" and hence solves our purpose of synchronizing the tasks. 
